            ...
            <div className="col-lg-8 posts-list">
               <div className="single-post">
                  <div className="feature-img">
                     <img className="src/img-fluid" src="img/blog/single_blog_1.png" alt=""/>
                  </div>
                  ...
                  <div className="navigation-area">
                     <div className="row">
                        <div
                           ...
                           <div className="thumb">
                              <a href="#">
                                 <img className="src/img-fluid" src="img/post/preview.png" alt=""/>
                              </a>
                           </div>
                           <div className="arrow">
                              <a href="#">
                        ...
                        <div
                           ...
                           <div className="thumb">
                              <a href="#">
                                 <img className="src/img-fluid" src="img/post/next.png" alt=""/>
                              </a>
                           </div>
                        </div>
                     </div>
               ...
               <div className="blog-author">
                  <div className="media align-items-center">
                     <img src="src/img/blog/author.png" alt=""/>
               ...
               <div className="comments-area">
                  ...
                  <div className="comment-list">
                     <div className="single-comment justify-content-between d-flex">
                        <div className="user justify-content-between d-flex">
                           <div className="thumb">
                              <img src="src/img/comment/comment_1.png" alt=""/>
                           </div>
                           <div className="desc">
                              <p className="comment">
                  ...
                  <div className="comment-list">
                     <div className="single-comment justify-content-between d-flex">
                        <div className="user justify-content-between d-flex">
                           <div className="thumb">
                              <img src="src/img/comment/comment_2.png" alt=""/>
                           </div>
                           <div className="desc">
                              <p className="comment">
                                 Multiply sea night grass fourth day sea lesser rule open subdue female fill which them
                  ...
                  <div className="comment-list">
                     <div className="single-comment justify-content-between d-flex">
                        <div className="user justify-content-between d-flex">
                           <div className="thumb">
                              <img src="src/img/comment/comment_3.png" alt=""/>
                           </div>
                           <div className="desc">
                              <p className="comment">
                                 Multiply sea night grass fourth day sea lesser rule open subdue female fill which them
               ...
               <div className="blog_right_sidebar">
                  <aside className="single_sidebar_widget search_widget">
                     <form action="#">
                        ...
                        <button className="button rounded-0 primary-bg text-black w-100 btn_1 boxed-btn"
                  ...
                  <aside className="single_sidebar_widget popular_post_widget">
                     ...
                     <div className="media post_item">
                        <img src="src/img/post/post_1.png" alt="post"/>
                        <div className="media-body">
                     ...
                     <div className="media post_item">
                        <img src="src/img/post/post_2.png" alt="post"/>
                        <div className="media-body">
                           <a href="single-blog.html">
                     ...
                     <div className="media post_item">
                        <img src="srcimg/post/post_3.png" alt="post"/>
                        <div className="media-body">
                           <a href="single-blog.html">
                     ...
                     <div className="media post_item">
                        <img src="src/img/post/post_4.png" alt="post"/>
                        <div className="media-body">
                           <a href="single-blog.html">
                  ...
                  <aside className="single_sidebar_widget instagram_feeds">
                     ...
                     <ul className="instagram_row flex-wrap">
                        <li>
                           <a href="#">
                              <img className="img-fluid" src="src/img/post/post_5.png" alt=""/>
                           </a>
                        </li>
                        <li>
                           <a href="#">
                              <img className="img-fluid" src="src/img/post/post_6.png" alt=""/>
                           </a>
                        </li>
                        <li>
                           <a href="#">
                              <img className="img-fluid" src="src/img/post/post_7.png" alt=""/>
                           </a>
                        </li>
                        <li>
                           <a href="#">
                              <img className="src/img-fluid" src="img/post/post_8.png" alt=""/>
                           </a>
                        </li>
                        <li>
                           <a href="#">
                              <img className="src/img-fluid" src="img/post/post_9.png" alt=""/>
                           </a>
                        </li>
                        <li>
                           <a href="#">
                              <img className="src/img-fluid" src="img/post/post_10.png" alt=""/>
                           </a>
                        </li>
                     </ul>
                  </aside>
