...
function Elements(){
	...
	<section className="button-area">
		<div className="container box_1170 border-top-generic">
			...
			<div className="button-group-area mt-10">
				<a href="#" className="genric-btn default-border circle arrow">Default<span
						className="lnr lnr-arrow-right"></span></a>
				<a href="#" className="genric-btn primary-border circle arrow">Primary<span
						className="lnr lnr-arrow-right"></span></a>
				<a href="#" className="genric-btn success-border circle arrow">Success<span
						className="lnr lnr-arrow-right"></span></a>
				<a href="#" className="genric-btn info-border circle arrow">Info<span
						className="lnr lnr-arrow-right"></span></a>
				<a href="#" className="genric-btn warning-border circle arrow">Warning<span
						className="lnr lnr-arrow-right"></span></a>
				<a href="#" className="genric-btn danger-border circle arrow">Danger<span
						className="lnr lnr-arrow-right"></span></a>
			</div>
			<div className="button-group-area mt-40">
			...
			<div className="section-top-border">
				...
				<div className="row">
					<div className="col-md-3">
						<img src="src/img/elements/d.jpg" alt="" className="img-fluid"/>
					</div>
				...
				<div className="progress-table-wrap">
					<div className="progress-table">
						...
						<div className="table-row">
							...
							<div className="country"> <img src="src/img/elements/f1.jpg" alt="flag"/>Canada</div>
						...
						<div className="table-row">
							...
							<div className="country"> <img src="src/img/elements/f2.jpg" alt="flag"/>Canada</div>
							<div className="visit">645032</div>
							<div className="percentage">
								<div className="progress">
						...
						<div className="table-row">
							...
							<div className="country"> <img src="src/img/elements/f3.jpg" alt="flag"/>Canada</div>
							<div className="visit">645032</div>
							<div className="percentage">
								<div className="progress">
						...
						<div className="table-row">
							...
							<div className="country"> <img src="src/img/elements/f4.jpg" alt="flag"/>Canada</div>
							<div className="visit">645032</div>
							<div className="percentage">
								<div className="progress">
						...
						<div className="table-row">
							...
							<div className="country"> <img src="src/img/elements/f5.jpg" alt="flag"/>Canada</div>
							<div className="visit">645032</div>
							<div className="percentage">
								<div className="progress">
						...
						<div className="table-row">
							...
							<div className="country"> <img src="src/img/elements/f6.jpg" alt="flag"/>Canada</div>
							<div className="visit">645032</div>
							<div className="percentage">
								<div className="progress">
						...
						<div className="table-row">
							...
							<div className="country"> <img src="src/img/elements/f7.jpg" alt="flag"/>Canada</div>
							<div className="visit">645032</div>
							<div className="percentage">
								<div className="progress">
						...
						<div className="table-row">
							...
							<div className="country"> <img src="src/img/elements/f8.jpg" alt="flag"/>Canada</div>
							<div className="visit">645032</div>
							<div className="percentage">
								<div className="progress">
